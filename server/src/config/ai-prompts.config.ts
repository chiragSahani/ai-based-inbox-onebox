...
export const EMAIL_CATEGORIZATION_SYSTEM_INSTRUCTION =
...
export const VALID_AI_CATEGORIES: AICategory[] = [
  'Interested',
  'Meeting Booked',
  'Not Interested',
  'Follow Up',
