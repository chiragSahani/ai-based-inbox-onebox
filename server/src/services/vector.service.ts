...
export class VectorService {
  ...
  private readonly vectorSize = 768; // text-embedding-004 produces 768-dimensional vectors
  ...
  private async initializeSampleData(): Promise<void> {
    const sampleData: ProductData[] = [
      ...
      {
        id: '3',
        text: `Product: ReachInbox — an AI-powered email management platform. Outreach: If lead is interested in scheduling, share the meeting booking link: ${config.webhooks.bookingLink}. Tone: friendly-professional. Available Monday-Friday, 9 AM - 6 PM EST. For urgent requests, email support@reachinbox.com`,
  ...
  async searchSimilar(query: string, topK: number = 3): Promise<string[]> {
    try {
